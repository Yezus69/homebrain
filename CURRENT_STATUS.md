...
Goal 6B DA3 pose diagnostics, stable-window weak labels, CUDA DA3 repair, and TUM RGB-D truth-anchor import completed; no SpatialMemoryNet training started.

## Last completed goal

Goal 6B: DA3 pose outlier diagnosed exactly, stable windows selected, window-gated DA3 weak BEV packed/QA'd, CUDA DA3 smoke repaired, full 350-frame DA3 run completed, and TUM RGB-D freiburg1_xyz anchor packed/QA'd.
