...
Goal 7 DINO-feature SpatialMemoryNet v0 tiny overfit and replay integration completed; checkpoint is representation-pretraining-only and not control-safe.

## Last completed goal

Goal 7: DINOv2-small/fake DINO feature teacher support, SpatialTrainPack grading cleanup, SpatialMemoryNet v0 tiny overfit, eval CLI, modeld/replayd checkpoint inference, and BEV contact sheet visualization.
