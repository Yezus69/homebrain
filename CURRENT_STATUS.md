...
Goal 7B SpatialMemoryNet v0 real train/val source comparison completed; checkpoints are representation-pretraining-only and not control-safe.

## Last completed goal

Goal 7B: deterministic sequence-aware SpatialTrainPack splits, TUM camera-relative pose labels, multi-pack SpatialMemoryNet v0 train/eval, DA3/TUM source comparison, and modeld/replayd checkpoint inference on real routes.
